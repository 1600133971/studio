...
public class SpellCheckedTextBox {
	...
	private void initializeContextMenu() {
		...
		Object[][] operations = {
				{ Messages.Undo, ITextOperationTarget.UNDO },
				{ Messages.Redo, ITextOperationTarget.REDO },
				{ "", -1 }, // separator
				{ Messages.Cut, ITextOperationTarget.CUT },
				{ Messages.Copy, ITextOperationTarget.COPY },
				{ Messages.Paste, ITextOperationTarget.PASTE },
				{ "", -1 }, // separator
				{ Messages.SelectAll, ITextOperationTarget.SELECT_ALL } };
